...
public class BannerController {
    ...
    @ApiOperation(value = ApiDocMsg.POST_TITLE_MSG, notes = ApiDocMsg.BANNER_NAME +
            ApiDocMsg.POST_NOTES_CMN_TABLE_MSG) // For Swagger API documentation
    ...
    public ResponseEntity<BannerSingleResponse> postChute(@Validated @RequestBody final BannerSingleRequest req) {
        log.info("→Request：{}", StringUtils.replace(Objects.toString(req, "null"),
                "[\r\n]", ""));
    ...
    @ApiOperation(value = ApiDocMsg.PUT_TITLE_MSG, notes = ApiDocMsg.BANNER_NAME +
            ApiDocMsg.PUT_NOTES_CMN_TABLE_MSG) // For Swagger API documentation
