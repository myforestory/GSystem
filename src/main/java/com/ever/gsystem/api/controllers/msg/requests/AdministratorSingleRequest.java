...
/**
 * [單體]首頁AdministratorMaster畫面REQUEST MESSAGE.
 *
...
public class AdministratorSingleRequest implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = 4258082436921751483L;
