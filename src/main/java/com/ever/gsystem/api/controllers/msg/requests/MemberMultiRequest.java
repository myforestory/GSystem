...
public class MemberMultiRequest implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = -7030904023285090177L;

    /** MemberMaster. */
    @Valid
    @ApiModelProperty(value = ApiDocMsg.MEMBER_NAME + "（複數可）", position = 1)
    private List<MstMember> mstMember;
}
