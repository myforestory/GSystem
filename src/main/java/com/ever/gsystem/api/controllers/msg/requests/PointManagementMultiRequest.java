...
/**
 * [複數]點數管理Master畫面REQUEST MESSAGE.
 *
...
public class PointManagementMultiRequest implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = 8977905272974503418L;

    /** PointManagementMaster. */
    @Valid
    @ApiModelProperty(value = ApiDocMsg.POINT_MANAGEMENT_NAME + "（複數可）", position = 1)
    private List<MstPointManagement> mstPointManagement;
}
