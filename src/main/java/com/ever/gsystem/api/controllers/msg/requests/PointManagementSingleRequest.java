...
/**
 * [單體]點數管理Master畫面REQUEST MESSAGE.
 *
...
public class PointManagementSingleRequest implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = 7282268587979999752L;

    /** PointManagementMaster. */
    @Valid
    @ApiModelProperty(position = 1)
    private MstPointManagement mstPointManagement;
}
