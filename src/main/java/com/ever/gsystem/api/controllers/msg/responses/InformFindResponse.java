...
/**
 * [檢索用]通知消息Master畫面RESPONSE MESSAGE.
 *
...
public class InformFindResponse implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = -2883902516623235629L;

    /** InformMaster. */
    @ApiModelProperty(value = ApiDocMsg.INFORM_NAME + "（複數有）", position = 1)
    private final List<MstInform> mstInform;
