...
/**
 * [檢索用]點數管理Master畫面RESPONSE MESSAGE.
 *
...
public class PointManagementFindResponse implements Serializable {
    /** Serial version UID (change value if this class changes). */
    private static final long serialVersionUID = 3341683986976074524L;

    /** PointManagementMaster. */
    @ApiModelProperty(value = ApiDocMsg.POINT_MANAGEMENT_NAME + "（複數有）", position = 1)
    private final List<MstPointManagement> mstPointManagement;
